...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      current: location.pathname.startsWith('/proposals')
    },
    {
      name: 'Products',
      href: '/products',
  ...
  if (hasRole(USER_ROLES.ADMIN) || hasRole(USER_ROLES.OWNER)) {
    navigation.push(
      {
        name: 'Users',
        href: '/users',
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            <div className="flex-shrink-0 flex items-center px-4">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">HelioSuite</span>
            </div>
